...
fftp_pos_fd_fn = cs.Function('ff_t_ftp_fn', [palm_pose, ff_qpos], [ff_t_ftp[0:3, -1]])
...
mftp_pos_fd_fn = cs.Function('mftp_pos_fd_fn', [palm_pose, mf_qpos], [mf_t_ftp[0:3, -1]])
...
rftp_pos_fd_fn = cs.Function('rftp_pos_fd_fn', [palm_pose, rf_qpos], [rf_t_ftp[0:3, -1]])
...
thtp_pos_fd_fn = cs.Function('thtp_pos_fd_fn', [palm_pose, th_qpos], [th_t_ftp[0:3, -1]])
