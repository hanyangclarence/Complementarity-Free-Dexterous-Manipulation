...
class Contact:
    ...
    def reformat(self, contacts=None):
        ...
        # MuJoCo qvel: palm_linear_vel(3), palm_angular_vel(3), finger_qvel(22), obj_vel(6)
        # MPC qvel: obj_vel(6), palm_vel(6), finger_qvel(22)
        ...
        jac_mat_reorder[:, 12:] = jac_mat[:, 6:28]     # finger velocities (22 DOFs)
